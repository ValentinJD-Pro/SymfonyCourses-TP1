 ...
 */
final class Version20210131200600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, client_table_id INTEGER DEFAULT NULL, time DATETIME NOT NULL, prix_total DOUBLE PRECISION DEFAULT NULL, state VARCHAR(255) NOT NULL)');
