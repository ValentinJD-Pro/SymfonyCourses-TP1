 ...
 */
final class Version20210203174151 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client_order AS SELECT id, user_id, client_table_id, prix_total, state, time FROM client_order');
        $this->addSql('DROP TABLE client_order');
        $this->addSql('CREATE TABLE client_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, client_table_id INTEGER DEFAULT NULL, prix_total DOUBLE PRECISION DEFAULT NULL, time DATETIME DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_56440F2FA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_56440F2FC2191899 FOREIGN KEY (client_table_id) REFERENCES client_table (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO client_order (id, user_id, client_table_id, prix_total, state, time) SELECT id, user_id, client_table_id, prix_total, state, time FROM __temp__client_order');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE client_order');
        $this->addSql('CREATE TABLE client_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, client_table_id INTEGER DEFAULT NULL, time DATETIME DEFAULT NULL, prix_total DOUBLE PRECISION DEFAULT NULL, state VARCHAR(255) NOT NULL COLLATE BINARY)');
